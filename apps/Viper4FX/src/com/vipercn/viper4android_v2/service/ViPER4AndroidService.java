...
public class ViPER4AndroidService extends Service {
    ...
    private class V4ADSPModule {
        ...
        public V4ADSPModule(int nAudioSession) {
            try {
                ...
                Log.e("ViPER4", "Cannot create audio effect instance, driver not installed or not supported");
                mInstance = null;
            }
            ...
            if (mInstance != null) {
                ...
                mInstance.setControlStatusListener(new AudioEffect.OnControlStatusChangeListener() {
                    ...
                    public void onControlStatusChange(AudioEffect effect, boolean controlGranted) {
                        if (!controlGranted) {
                            Log.e("ViPER4", "Lost effect control token");
                ...
                mInstance.setEnableStatusListener(new AudioEffect.OnEnableStatusChangeListener() {
                    ...
                    public void onEnableStatusChange(AudioEffect effect, boolean enabled) {
                        ...
                        if (shouldEnabled != enabled) {
                            Log.e("ViPER4", "Experiencing no effect, because sound is controlled by the system");
        ...
        public void setParameter_px4_vx4x1(int param, int valueL) {
            try {
                ...
                Log.i("ViPER4", "setParameter_px4_vx4x1: " + e.getMessage());
            }
        }
        ...
        public void setParameter_px4_vx4x2(int param, int valueL, int valueH) {
            try {
                ...
                Log.i("ViPER4", "setParameter_px4_vx4x2: " + e.getMessage());
            }
        }
        ...
        public void setParameter_px4_vx4x3(int param, int valueL, int valueH, int valueE) {
            try {
                ...
                Log.i("ViPER4", "setParameter_px4_vx4x3: " + e.getMessage());
            }
        }
        ...
        public void setParameter_px4_vx4x4(int param, int valueL, int valueH, int valueE, int valueR) {
            try {
                ...
                Log.i("ViPER4", "setParameter_px4_vx4x4: " + e.getMessage());
            }
        }
        ...
        public void setParameter_px4_vx1x256(int param, int dataLength, byte[] byteData) {
            try {
                ...
                Log.i("ViPER4", "setParameter_px4_vx1x256: " + e.getMessage());
            }
        }
        ...
        public void setParameter_px4_vx1x1024(int param, float[] floatData) {
            try {
                ...
                Log.i("ViPER4", "setParameter_px4_vx1x1024: " + e.getMessage());
            }
        }
        ...
        public void setParameter_px4_vx2x8192(int param, int valueL, int dataLength, byte[] byteData) {
            try {
                ...
                Log.i("ViPER4", "setParameter_px4_vx2x8192: " + e.getMessage());
            }
        }
        ...
        public void setParameter_Native(byte[] parameter, byte[] value) {
            ...
            try {
                ...
                Log.i("ViPER", "setParameter_Native: " + e.getMessage());
            }
        }
        ...
        public int getParameter_px4_vx4x1(int param) {
            try {
                ...
                Log.i("ViPER4", "getParameter_px4_vx4x1: " + e.getMessage());
                return -1;
            }
        }
        ...
        public void getParameter_Native(byte[] parameter, byte[] value) {
            ...
            try {
                ...
                Log.i("ViPER4", "getParameter_Native: " + e.getMessage());
            }
        }
        ...
        public void setConvIRFile(String mConvIRFile, boolean bSpeakerParam) {
            ...
            if (!chkIrsFile.exists()) {
            	Log.e("ViPER4", "Convolver kernel does not exist");
                ...
                if (mConvIRFile.equals("")) {
                    ...
                    if (irs.LoadIrs(mConvIRFile)) {
                        ...
                        if (V4AJniInterface.IsLibraryUsable()) {
                            ...
                            Log.e("ViPER4", "Failed to load " + mConvIRFile);
                        }
                    }
                }
            }
        ...
        public void onReceive(Context context, Intent intent) {
                ...
                if (mV4AMutex.acquire()) {
                    if (mGeneralFXList.indexOfKey(sessionId) < 0) {
                        ...
                        if (v4aNewDSPModule.mInstance == null) {
                            Log.e("ViPER4", "Failed to load driver.");
                    ...
                    Log.e("ViPER4", "Semaphore acquire failed.");
            }
            ...
            if (action.equals(AudioEffect.ACTION_CLOSE_AUDIO_EFFECT_CONTROL_SESSION)) {
                if (mV4AMutex.acquire()) {
                    ...
                    Log.e("ViPER4", "Semaphore accquire failed.");
            }
    ...
    public void onCreate() {
	    ...
	    aeuUtils = null;
            ...
            String mDriverVersion = "2" + iaDrvVer[0] + "." + iaDrvVer[1] + "." + iaDrvVer[2] + "."
                    + iaDrvVer[3];
            aeuUtils = null;
            if (!ViPER4Android.isDriverCompatible(mDriverVersion)) {
            	Log.e("ViPER4", "Engine is not compatible with service");
            	mDriverIsReady = false;
            	return;
            }
        }
        ...
        if (mGeneralFX != null) {
            Log.e("ViPER4", "Service: onCreate, mGeneralFX != null");
            mGeneralFX.release();
            mGeneralFX = null;
        }
        ...
        if (mCompatibleMode.equalsIgnoreCase("global")) {
            ...
            if (mGeneralFX.mInstance == null) {
                Log.e("ViPER4", "Service: Found driver but failed to load.");
                mGeneralFX.release();
                mGeneralFX = null;
            }
        }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (!mDriverIsReady) {
            Log.e("ViPER4", "Service: onStartCommand [Engine not found]");
        ...
        if (mGeneralFX == null) {
            ...
            if (mGeneralFX.mInstance == null) {
                ...
                Log.e("ViPER4", "Service: onStartCommand [Found driver but failed to load]");
                mGeneralFX.release();
                mGeneralFX = null;
                return super.onStartCommand(intent, flags, startId);
            }
    ...
    void updateSystem_Global(SharedPreferences preferences, int mFXType, boolean mRequireReset,
        ...
        if (mGeneralFX == null || mGeneralFX.mInstance == null || !mDriverIsReady) {
            Log.e("ViPER4", "updateSystem(): Effects is invalid!");
            return;
        }
        ...
        try {
            ...
            Log.e("ViPER4", "updateSystem_Global(), Exception = " + e.getMessage());
            return;
        }
        ...
        if (mV4AMutex.acquire()) {
            ...
            for (int idx = 0; idx < mGeneralFXList.size(); idx++) {
                ...
                try {
                    ...
                    Log.e("ViPER4", String.format("Trouble trying to manage session %d, removing...",
                            sessionId));
            ...
            Log.i("ViPER4", "Semaphore accquire failed.");
    }
