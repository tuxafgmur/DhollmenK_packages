...
public class PieControl implements PieMenu.PieController, OnClickListener {
    ...
    public boolean onOpen() {
        ...
        if (view != null) {
            ...
            if (mUiController.getSettings().hasDesktopUseragent(view)) {
                ...
                icon.setImageResource(R.drawable.ic_desktop_holo);
            }
        }
        return true;
    }
    ...
    protected void populateMenu() {
        mBack = makeItem(R.drawable.ic_back_holo, 1);
        mUrl = makeItem(R.drawable.ic_web_holo, 1);
        mBookmarks = makeItem(R.drawable.ic_bookmarks_holo, 1);
        mHistory = makeItem(R.drawable.ic_history_holo, 1);
        mAddBookmark = makeItem(R.drawable.ic_bookmark_on_holo, 1);
        mRefresh = makeItem(R.drawable.ic_refresh_holo, 1);
        mForward = makeItem(R.drawable.ic_forward_holo, 1);
        mNewTab = makeItem(R.drawable.ic_new_window_holo, 1);
        mIncognito = makeItem(R.drawable.ic_new_incognito_holo, 1);
        mClose = makeItem(R.drawable.ic_close_window_holo, 1);
        mInfo = makeItem(android.R.drawable.ic_menu_info_details, 1);
        mFind = makeItem(R.drawable.ic_search_holo, 1);
        mShare = makeItem(R.drawable.ic_share_holo, 1);
        View tabs = makeTabsView();
        mShowTabs = new PieItem(tabs, 1);
        mOptions = makeItem(R.drawable.ic_settings_holo, 1);
        mRDS = makeItem(R.drawable.ic_desktop_holo, 1);
    ...
    protected View makeTabsView() {
        ...
        image.setImageResource(R.drawable.ic_windows_holo);
