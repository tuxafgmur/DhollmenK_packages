...
public final class Launcher extends Activity
    ...
    private static final int RESTORE_SCREEN_ORIENTATION_DELAY = 0;
    ...
    // We only want to get the SharedPreferences once since it does an FS stat each time we get it from the context.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (! SystemProperties.get("ro.product.rkg").equals("1")) {
            throw new RuntimeException("Failing checking launcher");
	}
    ...
    public void onWindowVisibilityChanged(int visibility) {
        ...
        if (mVisible) {
            ...
            // When Launcher comes back to foreground, a different Launcher might be made default so refresh the icon
