...
public class Workspace extends PagedView
    ...
    private static final int CHILDREN_OUTLINE_FADE_OUT_DURATION = 175;
    private static final int CHILDREN_OUTLINE_FADE_IN_DURATION = 50;

    private static final int BACKGROUND_FADE_OUT_DURATION = 150;
    private static final int ADJACENT_SCREEN_DROP_DURATION = 100;
